...
class Linear(DQN):
    ...
    def initialize_models(self):
        ...
        self.q_network = torch.nn.Linear(in_features=in_features, out_features=num_actions)
        self.target_network = torch.nn.Linear(in_features=in_features, out_features=num_actions)
        ##############################################################
        ######################## END YOUR CODE #######################
    ...
    def calc_loss(self, q_values : Tensor, target_q_values : Tensor,
        ...
        Q = torch.sum(F.one_hot(actions.long(), num_classes=num_actions) * q_values, axis=1)
