...
class PolicyGradient(object):
    ...
    def init_policy(self):
        ...
        policy_network = build_mlp(self.observation_dim, self.action_dim, self.config.n_layers, self.config.layer_size)
        self.policy = CategoricalPolicy(policy_network) if self.discrete else GaussianPolicy(policy_network, self.action_dim)
